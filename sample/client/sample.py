...
login_address_forclinet = None
login_port_for_clinet = None
sock_port = None
username_ = None
available_contacts = []
client_socket = None
...
if __name__ == "__main__":
    ...
    def send_message(targetuserid, message):
        ...
        if f==0:
            ...
            try:
                response = requests.post(f"http://{target_ip}:{target_port}/", json=message_request, timeout=10)
